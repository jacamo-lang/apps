...
/* Because a lot of percepts I do not do anything */
/*+!select_goal : is_almost_full_map <- 
				!init_goal(recharge). */
				//.print("Almost full-map. I do not need do anything").
...
+!select_goal: //TODO ajustar para 3
	(there_is_more_repairers(RepairerNameFriend) & numberWaits(K) & K >= 4) | (step(0) & not nextStepRepairerAll(10))
<-
...
//+!select_goal : is_parry_goal_strong & not is_disabled <- !init_goal(parry).
