...
can_expand_to(V) :-
		...
		&
		.print("MyV: ", MyV, " MyW1: ", MyW1, " MyY1: ", MyY1, " # V: ", V, " # MyW2: ", MyW2, " MyY2: ", MyY2).
...
can_expand_to(V) :-
		...
		&
		.print("MyV: ", MyV, " MyW1: ", MyW1, " MyY1: ", MyY1, " # V: ", V, " W1: ", W1, " # MyW2: ", MyW2, " MyY2: ", MyY2, " W2: ", W2).
	 
get_next_agent_token(Agent) :-
	.my_name(MyName) & 
	generalPriority(MyName, 20) &
