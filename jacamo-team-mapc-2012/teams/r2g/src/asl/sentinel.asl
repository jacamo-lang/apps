...
+!select_goal : is_survey_goal & not is_disabled & pathTogoSwarm(_, _) & not is_at_swarm_position  <- !init_goal(survey).
...
+!select_goal : is_at_swarm_position <- !init_goal(recharge).
