...
is_almost_full_map :- step(S) & S > 150 & sumVertices(Total) & zonesScore(Score) & Score >= Total * 0.8.

is_good_map_conquered :- step(S) & S > 200 & noMoreVertexToProbe & sumVertices(Total) & zonesScore(Score) & Score >= Total * 0.32.
is_good_map_conquered :- step(S) & S > 150 & noMoreVertexToProbe & sumVertices(Total) & zonesScore(Score) & Score >= Total * 0.35.
is_good_map_conquered :- step(S) & S > 100 & noMoreVertexToProbe & sumVertices(Total) & zonesScore(Score) & Score >= Total * 0.4.
is_good_map_conquered :- step(S) & S > 50 & noMoreVertexToProbe & sumVertices(Total) & zonesScore(Score) & Score >= Total * 0.5.
