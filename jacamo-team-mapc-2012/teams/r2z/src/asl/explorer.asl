 ...
 */
 //TODO GRAVE: DESCOMENTAR OS DOIS
 /*
...
+!select_goal : is_leave_goal & not is_disabled & not is_almost_full_map <- .print("Enemy here, leaving..."); !init_goal(searchBestVertex).
...
+!notifySaboteursAboutEnemy(Entity, V, Team, normal):
	...
	.my_name(saboteur1)
<-
	.send(saboteur2, tell, visibleEntityTell(Entity, V, Team, normal));
	.send(saboteur3, tell, visibleEntityTell(Entity, V, Team, normal));
	.send(saboteur4, tell, visibleEntityTell(Entity, V, Team, normal)).
	
+!notifySaboteursAboutEnemy(Entity, V, Team, normal):
	not myTeam(Team) & 
	.my_name(saboteur2)
<-
	.send(saboteur1, tell, visibleEntityTell(Entity, V, Team, normal));
	.send(saboteur2, tell, visibleEntityTell(Entity, V, Team, normal));
	.send(saboteur4, tell, visibleEntityTell(Entity, V, Team, normal)).
...
+!unnotifySaboteursAboutEnemy(Entity, V, Team, normal):
	...
	.my_name(saboteur1)
<-
	.send(saboteur2, untell, visibleEntityTell(Entity, V, Team, _));
	.send(saboteur3, untell, visibleEntityTell(Entity, V, Team, _));
	.send(saboteur4, untell, visibleEntityTell(Entity, V, Team, _)).
	
+!unnotifySaboteursAboutEnemy(Entity, V, Team, normal):
	not myTeam(Team) &
	.my_name(saboteur2)
<-
	.send(saboteur1, untell, visibleEntityTell(Entity, V, Team, _));
	.send(saboteur3, untell, visibleEntityTell(Entity, V, Team, _));
	.send(saboteur4, untell, visibleEntityTell(Entity, V, Team, _)).
