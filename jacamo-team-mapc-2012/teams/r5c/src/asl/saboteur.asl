...
//+!select_goal : strategy(1) & not is_at_swarm_position & get_vertex_to_go_attack_search(D, Path) & not is_at_swarm_position_test <- !init_goal(gotoPathAttack(Path)).
