...
+!select_goal:
	.my_name(repairer4) & nextStepRepairerAll(X) & X < 3 & numberWaits(K)
<-	
	.print("Waiting decision");
	//.wait({+nextStepRepairer(repairer2, V)}, 1000, EventTime);
	//.wait({+nextStepRepairerAll(3)},150);
	.wait(150);
	-+numberWaits(K+1);
	!select_goal.
	
+!select_goal:
	.my_name(repairer3) & nextStepRepairerAll(X) & X < 2 & numberWaits(K)
<-	

	.print("Waiting decision");
	//.wait({+nextStepRepairerAll(2)},150);
	.wait(150);
	-+numberWaits(K+1);
	!select_goal.
	
+!select_goal:
	.my_name(repairer2) & nextStepRepairerAll(X) & X < 1 & numberWaits(K)
<-	

	.print("Waiting decision");
	//.wait({+nextStepRepairerAll(1)},150);
	.wait(150);
	-+numberWaits(K+1);
	!select_goal.
...
+!select_goal : waitABit <- 
	...
	!init_goal(recharge).
+!select_goal : is_route_goal <- !init_goal(random_walk). //I'm going to cure some agent
...
<-
	...
	.print("I'm going to repair other friend and cancel my appointment with ", RepairerName).
...
<- 
	.send(repairer2,tell,nextStepRepairer(repairer1, V));
	.send(repairer3,tell,nextStepRepairer(repairer1, V));
	.send(repairer4,tell,nextStepRepairer(repairer1, V));
	-+stepDone(S);
	repair(V);
	!clearDecision.
...
<- 
	.send(repairer3,tell,nextStepRepairer(repairer2, V));
	.send(repairer4,tell,nextStepRepairer(repairer2, V));
	-+stepDone(S);
	repair(V);
	!clearDecision.
...
<- 
	.send(repairer4,tell,nextStepRepairer(repairer3, V));
	-+stepDone(S);
	repair(V);
	!clearDecision.
...
<-
	.send(repairer2,tell,nextStepRepairer(repairer1, repairer1Skip));
	.send(repairer3,tell,nextStepRepairer(repairer1, repairer1Skip));
	.send(repairer4,tell,nextStepRepairer(repairer1, repairer1Skip));
...
<-
	.send(repairer3,tell,nextStepRepairer(repairer2, repairer2Skip));
	.send(repairer4,tell,nextStepRepairer(repairer2, repairer2Skip));
...
<-
	.send(repairer4,tell,nextStepRepairer(repairer3, repairer3Skip)); 
