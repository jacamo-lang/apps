    	...
    	if (lastPercepts != null) {
	    	...
	    	for (Literal l : lastPercepts) {
	    		...
	    		if (functor.equals("visibleEdge")) {
	    			...
	    			/*
	    			if (getAgName().equals("saboteur1"))
	    				System.out.println("# visibleVertex: " + terms.get(0) + " T: " + terms.get(1) + " " + terms.get(1).getClass().getName() + " " + getAgName());*/
	    			continue;
	    	...
	    	if (lSimEnd != null) {
	    		...
	    		for (Literal l : lastPercepts) { //TODO tirar isso
	    			System.out.println("PERCEPT: " + l); 
	    		}
	    	}
	    	lastPercepts = null;
    	}
