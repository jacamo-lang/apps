...
is_good_map_conquered :- step(S) & S > 150 & noMoreVertexToProbe & sumVertices(Total) & zonesScore(Score) & Score >= Total * 0.35 & at_some_good_zone_score(0.35).
...
is_dangerous_entity(Entity) :- myTeam(MyTeam) & entity(Entity, Team, V, normal) & Team \== MyTeam & (not entityType(Entity, _) | entityType(Entity, "Saboteur")).